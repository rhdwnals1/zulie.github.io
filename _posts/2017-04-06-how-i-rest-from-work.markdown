...
layout: post
title: First Article
date: 2021-04-18 19:48:20 +0800
description: You’ll find this post in your `_posts` directory. Go ahead and edit it and re-build the site to see your changes. # Add post description (optional)
img: i-rest.jpg # Add image post (optional)
fig-caption: # Add figcaption (optional)
tags: [First, JuminKong]
---

그동안 블로그를 velog로만 사용하다가 이번에 github으로 블로그를 쓰고 싶어서 repo를 새로 만들고 테마까지 다운받아서 나만의 블로그로 만들어 보았다.
여태까지 메모장처럼 썼던 블로그를 이제는 좀 예쁘게 가독성이 좋게 써보려고 한다 호호호

## 이건 깃헙의 마크다운을 확인하기 위한 테스트 !!
